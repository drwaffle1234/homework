...
public class MagicMain extends JApplet implements ActionListener {
	...
	Button addHealth6, subHealth6, poison6;
	...
	public void init() {
		...
		addHealth6 = new Button("add Health");
		addHealth6.setSize(70, 25);
		addHealth6.setLocation(270, 300);
		add(addHealth6);
		...
		subHealth6 = new Button("sub Health");
		subHealth6.setSize(70, 25);
		subHealth6.setLocation(350, 300);
		add(subHealth6);
		...
		showHealth6 = new TextField(player6.getHealthinString());
		showHealth6.setSize(50, 50);
		showHealth6.setLocation(300, 240);
		add(showHealth6);
		...
		subHealth6.addActionListener(this);
		...
		addHealth6.addActionListener(this);
	}
	...
	public void actionPerformed(ActionEvent evt) {
		if (evt.getSource() == addHealth) {
			...
			player5.SubOne();
			showHealth5.setText(player5.getHealthinString());
		} else if (evt.getSource() == addHealth6) {
			player6.plusOne();
			showHealth6.setText(player6.getHealthinString());
		} else if (evt.getSource() == subHealth6) {
			player6.SubOne();
			showHealth6.setText(player6.getHealthinString());
